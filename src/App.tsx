          ...
          <div className="main-display">
            ...
            <div className="support-section">
              ...
              <div className="support-links">
                ...
                <a
                  href="https://m3.aircash.eu/acpay/martins3764"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="support-link aircash"
                  title="Aircash"
                >
                  <svg
                    viewBox="0 0 24 24"
                    ...
                    xmlns="http://www.w3.org/2000/svg"
                  >
                    <path d="M20 4H4c-1.1 0-1.99.9-1.99 2L2 18c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 4H4v2h16V8zm0 4H4v2h16v-2zm0 4H4v2h16v-2z" />
                  </svg>
                  Aircash
                </a>
                <a
